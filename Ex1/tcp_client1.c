...
int main(int argc, char **argv)
{
	...
	*/
	...
	/*  Represent an entry in the hosts database.
			struct hostent {
    ...
    */
	...
	// gethostbyname() is obsolete :: https://linux.die.net/man/3/gethostbyname
	...
	if (ret != 0)
	{ // on connection/binding succeeds, 0 is return else -1 is returned on error
...
void str_cli(FILE *fp, int sockfd)
{
	...
	if (fgets(sends, MAXSIZE, fp) == NULL) //EoF encountered
	{
		printf("error input\n");
	}
